CREATE DATABASE BD_LOCADORA_DE_FILMES;
GO
USE BD_LOCADORA_DE_FILMES;
GO
...
--VER FILMES
CREATE OR ALTER PROCEDURE SP_VER_FILME

--Parametros da procedure
(@titulo varchar(50), @genero varchar(50), @alugado char)
AS

--declarar variaveis para checagem
DECLARE @TITULOFILME VARCHAR(50)
SELECT * FROM FILMES
...
EXEC SP_VER_FILME 'A VOLTA DOS QUE NAO FORAM',' ', ' '